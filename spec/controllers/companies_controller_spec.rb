...
describe CompaniesController do
  ...
  describe " POST :create" do
    context '保存に成功した場合' do
      subject { post :create, company: { name: "hoge", address: "body", tel: "03-0000-0000", fax: "03-1111-1111", url: "http://example.com"} }
      # 件数が増えているかどうか確認する
    ...
    context 'validation errorになった場合' do
      subject { post :create, company: { name: "hoge", address: "body", fax: "03-1111-1111", url: "http://example.com"} }
      # 件数が増えているかどうか確認する
